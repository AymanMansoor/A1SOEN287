...
<div class="container-2">
    <form action="P5Logingout.php" method="post" class="email-pass" id="login-form">
        ...
        <div class="box2">    
            <input type="text" class="form-control" id="eml" placeholder="Email" type="email" class="eml" size="40">
            <input type="text" class="form-control" id="pswrd" placeholder="Password" name="pswrd" size="40">
        </div>
