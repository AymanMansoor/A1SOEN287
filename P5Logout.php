...
<a href="P5Logout.php"><i class="fa fa-user"></i><?php php echo $_SESSION['email']; ?></a>
...
<!--big menu-->
  <div class="menu"><a href="P5Logout.php"><i class="fa fa-user"></i><?php php echo $_SESSION['email']; ?></a></div> 
...
<div class="container-2">
    <form action="P5Logingout.php" method="post" class="email-pass" id="login-form">
        <div class="page-header">
            <b><h3>Sign Out</h3></b>
        </div>
    
        <div class="box2">    
            <input type="text" class="form-control" id="eml" placeholder="Email" type="email" class="eml" size="40" required>
            <input type="text" class="form-control" id="pswrd" placeholder="Password" name="pswrd" size="40" required>
        </div>
        ...
        <div class="remember-login">
            ...
            <button type="submit" class="button" value="Submit Form" name="logout-btn">LOG OUT</button>
        </div>
        ...
        <div class="box3">
            ...
            <a href="P6text.html" id="sun" class="form-control" role="button">SIGN UP NOW</a>
        </div>
    </form>
</div>
